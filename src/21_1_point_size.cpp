...
int main() {
  ...
  // Render each single primitive as a point
  glPolygonMode(GL_FRONT_AND_BACK, GL_POINT);
  // Influencing point sizes in the vertex shader is disabled by default.
  // Without this, we would need to statically set point size by calling
  // glPointSize().
  ...
  Shader shader("shaders/21_1_point_size.vs",
                "shaders/21_1_point_size.fs");
